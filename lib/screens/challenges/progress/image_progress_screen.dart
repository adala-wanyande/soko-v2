...
class ImageProgressScreen extends StatefulWidget {
  ...
  const ImageProgressScreen({required this.title, super.key});

  @override
  // ignore: library_private_types_in_public_api
  _ImageProgressScreenState createState() => _ImageProgressScreenState();
}

class _ImageProgressScreenState extends State<ImageProgressScreen> {
  bool _imageFlipped = true;
